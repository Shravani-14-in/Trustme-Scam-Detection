              ...
              <div style={{
                ...
                <button
                  ...
                  style={{
                    ...
                    background: !message.trim() || loading ? "#e5e7eb" : "var(--accent)",
                    color: !message.trim() || loading ? "#9ca3af" : "#fff",
                    border: "none",
                    cursor: !message.trim() || loading ? "not-allowed" : "pointer",
                    fontFamily: "var(--font-display)", fontWeight: 700, fontSize: 13.5,
                    transition: "all 0.18s",
                    boxShadow: message.trim() && !loading ? "0 3px 12px rgba(79,70,229,0.35)" : "none",
                  }}
                  onMouseEnter={e => { if (message.trim() && !loading) { e.currentTarget.style.background = "#4338ca"; e.currentTarget.style.boxShadow = "0 4px 16px rgba(79,70,229,0.45)"; }}}
                  onMouseLeave={e => { if (message.trim() && !loading) { e.currentTarget.style.background = "var(--accent)"; e.currentTarget.style.boxShadow = "0 3px 12px rgba(79,70,229,0.35)"; }}}
                >
                  {loading
